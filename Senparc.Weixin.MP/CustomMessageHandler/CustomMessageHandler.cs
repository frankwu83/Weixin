...
namespace Senparc.Weixin.MP.MessageHandlers
{
    ...
    public partial class CustomMessageHandler : MessageHandler<MessageContext>
    {
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            if (requestMessage.Content == "help" || requestMessage.Content == "?" || requestMessage.Content == "h" || requestMessage.Content == "Help")
            {
                responseMessage.Content = WC.TxtMenu("");
            ...
            else
            {
                ...
                {
                    case "1":
                        responseMessagePic.Articles.Add(WC.TxtMsg("1"));
                        break;
                    case "2":
                        responseMessagePic.Articles.Add(WC.TxtMsg("2"));
                        break;
                    case "3":
                        responseMessagePic.Articles.Add(WC.TxtMsg("3"));
                        break;
                    case "4":
                        responseMessagePic.Articles.Add(WC.TxtMsg("4"));
                        break;
                    case "logo":
                        responseMessagePic.Articles.Add(WC.TxtMsg("logo"));
                        break;
                    case "6":
                        responseMessagePic.Articles.Add(WC.TxtMsg("1"));
                        responseMessagePic.Articles.Add(WC.TxtMsg("2"));
